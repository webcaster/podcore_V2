...
const translations = {
  de: {
    ...
    'nav.branding': 'Branding', 'nav.administration': 'Administration', 'nav.tutorials': 'Tutorial-Verwaltung',
  ...
  en: {
    ...
    'nav.branding': 'Branding', 'nav.administration': 'Administration', 'nav.tutorials': 'Tutorial Management',
