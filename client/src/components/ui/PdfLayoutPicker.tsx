...
interface PdfLayoutPickerProps {
  exportType: 'episode' | 'idea' | 'calendar' | 'invoice' | 'confirmation' | 'booking_calendar' | 'performance_report' | 'sponsor_dossier' | 'sponsor_offer' | 'question_pool' | 'season_planning' | 'interview_partner';
  value: string;
